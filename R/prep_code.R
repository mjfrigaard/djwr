...
#' @export prep_code
#'
#' @param folder_name name of folder for code files (string), defaults to 'R/'
#' @param header logical, include roxygen2 headers?
#'
...
prep_code <- function(folder_name = NULL, header = TRUE) {
