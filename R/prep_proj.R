...
#' # prep_proj(parent_dir = "/Users/mjfrigaard/Documents/", "my new project")
prep_proj <- function(parent_dir, proj_name) {
  ...
  download.file(url = "https://raw.githubusercontent.com/mjfrigaard/djwr/main/inst/rmarkdown/templates/ger2-README/README.Rmd",
